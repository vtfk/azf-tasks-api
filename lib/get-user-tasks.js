...
module.exports = async (context, graphUser, token) => {
  ...
  try {
    ...
    context.log.error(['tasks', userPrincipalName, 'get-visma-tasks', 'err', error])
  }
  ...
  try {
    ...
    context.log.error(['tasks', userPrincipalName, 'get-planner-tasks', 'err', error])
  }
  ...
  try {
    ...
    context.log.error(['tasks', userPrincipalName, 'get-outlook-tasks', 'err', error])
  }
  ...
  try {
    ...
    context.log(['tasks', userPrincipalName, 'tasks', tasks.totalCount])
